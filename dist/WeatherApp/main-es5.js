...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppDisplayWeatherDisplayWeatherComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSearchCitiesSearchCitiesComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _display_weather_display_weather_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./display-weather/display-weather.component */
    "./src/app/display-weather/display-weather.component.ts");
    /* harmony import */


    var _search_cities_search_cities_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./search-cities/search-cities.component */
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_cities_search_cities_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./search-cities/search-cities.component */
    "./src/app/search-cities/search-cities.component.ts");
    /* harmony import */


    var _display_weather_display_weather_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./display-weather/display-weather.component */
    "./src/app/display-weather/display-weather.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _search_cities_search_cities_component__WEBPACK_IMPORTED_MODULE_5__["SearchCitiesComponent"], _display_weather_display_weather_component__WEBPACK_IMPORTED_MODULE_6__["DisplayWeatherComponent"]],
  ...
  /***/
  function srcAppDisplayWeatherDisplayWeatherComponentLess(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDisplayWeatherDisplayWeatherComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DisplayWeatherComponent", function () {
      return DisplayWeatherComponent;
    });
    /* harmony import */
    ...
    var DisplayWeatherComponent = /*#__PURE__*/function () {
      function DisplayWeatherComponent(weatherService) {
        _classCallCheck(this, DisplayWeatherComponent);

        this.weatherService = weatherService;
        this.citiesWeather = [];
      }

      _createClass(DisplayWeatherComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.weatherService.citiesWeather().subscribe(function (cities) {
            _this.citiesWeather = cities;
          });
        }
      }]);
    ...
    DisplayWeatherComponent.ctorParameters = function () {
      return [{
        type: _weather_service__WEBPACK_IMPORTED_MODULE_2__["WeatherService"]
      }];
    };

    DisplayWeatherComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-display-weather',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./display-weather.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/display-weather/display-weather.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./display-weather.component.less */
      "./src/app/display-weather/display-weather.component.less"))["default"]]
  ...
  /***/
  function srcAppSearchCitiesSearchCitiesComponentLess(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSearchCitiesSearchCitiesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SearchCitiesComponent", function () {
      return SearchCitiesComponent;
    });
    /* harmony import */
    ...
    var _weather_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../weather.service */
    "./src/app/weather.service.ts");

    var SearchCitiesComponent = /*#__PURE__*/function () {
      function SearchCitiesComponent(weatherService) {
        _classCallCheck(this, SearchCitiesComponent);
      ...
      _createClass(SearchCitiesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this2 = this;

          this.countryQuery.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (query) {
            return _this2.weatherService.searchByCountry(query);
          })).subscribe(function (results) {
            _this2.map.clear();

            _this2.cityResult = [];
            _this2.countryResult = [];

            var _iterator = _createForOfIteratorHelper(results.countries),
                _step;
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if (!_this2.map.has(item.country)) {
                  var record = {
                    id: item.id,
                  ...
                  _this2.map.set(item.country, record);

                  _this2.countryResult.push({
                    id: item.id,
                    country: item.country
                  });
                } else {
                  var existingCountry = _this2.map.get(item.country);
          ...
          this.cityQuery.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])()).subscribe(function (query) {
            _this2.cityResult = _this2.citiesBySelectedCountry.filter(function (item) {
        ...
        key: "countrySelected",
        value: function countrySelected(country) {
          this.countryResult = [];
          this.citiesBySelectedCountry = this.map.get(country).cities;
        }
      }, {
        key: "citySelected",
        value: function citySelected(city) {
          if (this.selectedCities.length > 9) {
            this.cityResult = [];
            this.countryResult = [];
            alert("Maximum cities selected");
          } else {
            this.cityResult = this.cityResult.filter(function (item) {
              return item.id !== city.id;
            });
            var selectedCityPresent = this.selectedCities.find(function (item) {
              return item.id === city.id;
            });
        ...
        value: function getWeather() {
          var selectedCitiesIds = this.selectedCities.map(function (item) {
            return item.id;
          });
          this.weatherService.getWeather(selectedCitiesIds);
        }
      }]);
    ...
    SearchCitiesComponent.ctorParameters = function () {
      return [{
        type: _weather_service__WEBPACK_IMPORTED_MODULE_4__["WeatherService"]
      }];
    };

    SearchCitiesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: "app-search-cities",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./search-cities.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/search-cities/search-cities.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./search-cities.component.less */
      "./src/app/search-cities/search-cities.component.less"))["default"]]
  ...
  function srcAppWeatherServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var WeatherService = /*#__PURE__*/function () {
      ...
      _createClass(WeatherService, [{
        key: "searchByCountry",
        value: function searchByCountry(countryQuery) {
          var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
          params = params.append("country", countryQuery);
          return this.http.get("http://localhost:5000/api/search", {
            params: params
        ...
        value: function getWeather(cities) {
          ...
          return this.http.get("http://localhost:5000/api/weather", {
            params: params
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            if (!res.success) {
            ...
            _this3.weather.next(citiesWeather);

            _this3.router.navigate(['show-weather']);
          }); // this.weather.next(mockRes);
          // this.router.navigate(['show-weather']);
        }
      }, {
        key: "citiesWeather",
        value: function citiesWeather() {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\TouchNoteAssignment\WeatherApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
